...
class WebsocketPolicyServer:
    ...
    def __init__(
        ...
        host: str = "0.0.0.0",
        port: int = 10093,
        idle_timeout: int = -1,  # Idle timeout in seconds; -1 disables auto-shutdown
    ...
    async def _idle_watchdog(self, server):
        """Monitor idle time and shut down the server after timeout."""
        while True:
    ...
    async def _handler(self, websocket: websockets.asyncio.server.ServerConnection):
        ...
        while True:
            try:
                ...
                self._last_active = time.time()  # Refresh the activity timestamp whenever a message arrives
    ...
    def _route_message(self, msg: dict) -> dict:
        ...
        - Supports messages of form:
            {"type": "ping|infer|predict_action", "request_id": "...", "payload": {...}}
        ...
        if not isinstance(msg, dict):
            return {
                ...
                "request_id": "default",
                "error": {"message": "Message must be a dict", "payload_type": str(type(msg))},
            }
