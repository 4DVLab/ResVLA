...
from resVLA.dataloader.gr00t_lerobot.video import get_all_frames, get_frames_by_timestamps

from resVLA.dataloader.gr00t_lerobot.embodiment_tags import EmbodimentTag
from resVLA.dataloader.gr00t_lerobot.schema import (
    DatasetMetadata,
    DatasetStatisticalValues,
    LeRobotModalityMetadata,
    LeRobotStateActionMetadata,
)
from resVLA.dataloader.gr00t_lerobot.transform import ComposedModalityTransform
...
def calculate_dataset_statistics(parquet_paths: list[Path]) -> dict:
    ...
    for le_modality in tqdm(all_low_dim_data.columns, desc="Processing modalities"):
        ...
        # Check whether the data is empty or invalid
        try:
            np_data = np.vstack(
...
class LeRobotSingleDataset(Dataset):
    ...
    def _get_trajectories(self) -> tuple[np.ndarray, np.ndarray]:
        ...
        # v3.0
            ...
            # The saved index information should be readable directly here
            return np.array(trajectory_ids), np.array(trajectory_lengths)
    ...
    def _get_tasks(self) -> pd.DataFrame:
        ...
        if self._lerobot_version == "v2.0":
            ...
            df = df.reset_index()  # Turn the index into a regular column, typically named 'index'
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        action = []
        # TODO: add multi-embodiment action support
