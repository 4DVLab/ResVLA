...
from resVLA.model.tools import auto_get_trainable_modules
...
from resVLA.model.framework.share_tools import dict_to_namespace
from resVLA.model.framework.__init__ import build_framework
...
class baseframework(PreTrainedModel):
    ...
    def get_action_stats(self, unnorm_key=None, norm_stats=None):
        ...
        If norm_stats is not provided, use stats loaded on this model instance.
        """
