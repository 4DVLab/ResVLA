...
Each framework module (e.g., M1.py, QwenFast.py) should register itself:
    from resVLA.model.framework.framework_registry import FRAMEWORK_REGISTRY
...
def build_framework(cfg):
    ...
    if cfg.framework.name == "QwenOFT":
        from resVLA.model.framework.QwenOFT import Qwenvl_OFT
        return Qwenvl_OFT(cfg)
    elif cfg.framework.name == "QwenFast":
        from resVLA.model.framework.QwenFast import Qwenvl_Fast
