...
config_yaml=./examples/LIBERO/train_files/resvla_cotrain_libero.yaml
libero_data_root=playground/Datasets/LEROBOT_LIBERO_DATA
# data_mix=libero_all_with_plus
# data_mix=libero_plus
data_mix=libero_all
run_root_dir=./results/Checkpoints
run_id=${RUN_ID:-resvla_libero_2B}
