...
class ModelClient:
    ...
    def get_action_stats(unnorm_key: str, policy_ckpt_path) -> dict:
        """Read action normalization stats for client-side fallback unnormalization."""
        policy_ckpt_path = Path(policy_ckpt_path)
        model_config, norm_stats = read_mode_config(policy_ckpt_path)  # read config and norm_stats

        # unnorm_key = baseframework._check_unnorm_key(norm_stats, unnorm_key)  # This is also highly environment-specific.
