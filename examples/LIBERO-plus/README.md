...
export LIBERO_PLUS_CONFIG_PATH=${LIBERO_HOME}/config  # Path to LIBERO-plus config files
```

`LIBERO_PLUS_CONFIG_PATH` should point to the directory that contains LIBERO-plus `config.yaml`.
...
export LIBERO_PLUS_CONFIG_PATH=${LIBERO_PLUS_CONFIG_PATH:-${LIBERO_HOME}/config}
